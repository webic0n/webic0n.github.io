...
$(window).scroll(function () {
    ...
    if(wScroll > $('.content_services').offset().top - ($(window).height() / 2)){

        $('.content_services .is-growing').each(function () {

            $('.content_services .is-growing').addClass('clip')
...

{
    ...
    class Slideshow {
        ...
        createFrame() {
            ...
            this.DOM.svg.setAttribute('width','100vw');
