...
$(document).ready(function() {
    $('.advantage_item').addClass("hidden-elem").viewportChecker({
        classToAdd: 'advantage_bounce',
        offset: 100
    });
});
...
(function() {
    ...
    $('.global-menu__wrap').on("click","a", function (event) {
        ...
        overlay.elm.classList.remove('is-opened');
        overlay.timeStart = Date.now();
        overlay.renderLoop();
        elmHamburger.classList.remove('is-opened-navi');
        for (var i = 0; i < gNavItems.length; i++) {
            gNavItems[i].classList.remove('is-opened');
...
$(document).ready(function () {
    ...
    $('.top-line__list').on("click","a", function (event) {
        event.preventDefault();
        var id  = $(this).attr('href'),
            top = $(id).offset().top;
        $('body,html').animate({scrollTop: top}, 1500);
