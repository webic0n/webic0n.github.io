...
$(window).scroll(function () {
    ...
    if(wScroll > $('.content_services').offset().top - ($(window).height() / 2.5)){
    ...
    if(wScroll > $('.content_advantage').offset().top - ($(window).height() / 2)){

        $('.content_advantage .advantage_item').each(function () {

            $('.content_advantage .advantage_item').addClass('advantage_bounce')
