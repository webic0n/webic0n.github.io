...
$(document).ready(function() {
	...
	$('.store-title, .title-slide, .text-advantages, .who, .text-client, .our__clients-item, .text-footer, .invaited, .company__text-3, .text-company, .text-year, .footer__text-3, .text-footer, .title__service-build, .text-repairs, .our__repairs-item, .title__service-repairs, .service__repairs-item, .our__glass-item, .title__service-glass, .title__service-glass-3, .title__service-doors, .store-title, .title__service-glass-3, .our__doors-item, .text-atc, .atc__advantages-title, .title__service-atc, .bold-text').addClass("hidden").viewportChecker({
