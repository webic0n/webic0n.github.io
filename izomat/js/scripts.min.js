...
$(document).ready(function() {
	...
	$('.store-title, .title-slide, .text-advantages, .who, .text-client, .our__clients-item, .text-footer, .invaited, .compane-title__main, .company__text-3, .text-company, .text-year, .footer__text-3, .text-footer, .text-build, .title__service-build, .text-repairs, .our__repairs-item, .title__service-repairs, .service__repairs-item, .glass-description, .our__glass-item, .title__service-glass, .title__service-glass-3, .title__service-doors, .store-title, .title__service-glass-3, .our__doors-item, .text-atc, .atc__advantages-title, .title__service-atc, .bold-text').addClass("hidden").viewportChecker({
...
$(window).on('load', function () {
	...
	$('.container_header')
		.delay(500)
		.queue(function (next) { 
		$(this).addClass('animated-1 fadeInDown');
		next(); 
	});
...
var preloader    = $('#preloader'), // селектор прелоадера
    ...
    if (imagesCount >= imgSum && imagesCount > 0) {
        ...
        $("#preloader-perc").circularProgress({
            color: "#tracsparent",
            line_width: 0,
            height: "10vh",
            width: "100vw",
        ...
        function img_load () {
            ...
            $("#preloader-perc").circularProgress('animate', progress, 500);
        }
    } else {
        preloader.remove();
	}
